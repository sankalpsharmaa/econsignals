...
class OpenAlexSensor(BaseSensor):
    ...
    def collect(self) -> list[dict]:
        ...
        """
        from lib.db import upsert_author, link_paper_author
        from lib.normalize import normalize_author_name, canonical_paper_id
        ...
        print(f"[openalex] collected {len(papers)} papers", file=sys.stderr)
        return papers

...
_HIGH_RELEVANCE_ORGS: frozenset[str] = frozenset({"J-PAL", "Weiss Fund"})
...
class FundingSensor(BaseSensor):
    ...
    def run(self) -> dict:
        ...
        """
        from lib.db import log_sensor_start, log_sensor_end, upsert_deadline
